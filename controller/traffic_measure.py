...
if __name__ == "__main__":
    ...
    def test_flow_add():
        ...
        if (install_flag == '1'):
            ...
            install = 'false'
        nodeid='00:02:14:02:ec:58:94:40'
        nodeconnector=3
        ether_type=0x800
    ...
    def aggregate_traffic():
        ...
        #print("Aggregate Traffic (tx + rx) = " + str(agg) + " Bytes")
    ...
    cnt = 0
    result = []
    def execute_func(agg):
        global end
        global cnt
        global result

        # TODO
        tmp = aggregate_traffic()
        rate = tmp - agg
        rate = rate/1000000000.0
        
        print(str(cnt) + " sec Aggregate Traffic (tx + rx) = " + str(rate) + " GBytes/sec")
        
        cnt += 5
        
        result.append(str(cnt) + " " + str(rate))
        #print(result)
        #print(time.time())
